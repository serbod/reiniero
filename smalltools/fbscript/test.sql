-- Extracted from the Firebird 2.5 employee sample database using isql

-- SET SQL DIALECT 3; 

/* CREATE DATABASE 'employee' PAGE_SIZE 4096 DEFAULT CHARACTER SET NONE */
...
AS 
BEGIN SUSPEND; END ^
CREATE PROCEDURE ALL_LANGS RETURNS (CODE VARCHAR(5) CHARACTER SET NONE,
...
AS 
BEGIN SUSPEND; END ^
CREATE PROCEDURE DEPT_BUDGET (DNO CHAR(3) CHARACTER SET NONE)
...
AS 
BEGIN SUSPEND; END ^
CREATE PROCEDURE ORG_CHART RETURNS (HEAD_DEPT CHAR(25) CHARACTER SET NONE,
...
AS 
BEGIN SUSPEND; END ^
CREATE PROCEDURE SHIP_ORDER (PO_NUM CHAR(8) CHARACTER SET NONE)
AS 
BEGIN SUSPEND; END ^
CREATE PROCEDURE SHOW_LANGS (CODE VARCHAR(5) CHARACTER SET NONE,
GRADE SMALLINT,
CTY VARCHAR(15) CHARACTER SET NONE)
RETURNS (LANGUAGES VARCHAR(15) CHARACTER SET NONE)
AS 
BEGIN SUSPEND; END ^
CREATE PROCEDURE SUB_TOT_BUDGET (HEAD_DEPT CHAR(3) CHARACTER SET NONE)
