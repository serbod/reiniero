...
- Firebird DDL (e.g. table creation) and DML (e.g. inserting data) must be separated by a COMMIT. This may also apply to other databases. FPC bug 17829 tracks this, and it has been fixed in FPC 2.7.1/trunk revision 26120; it may be fixed in your version of FPC as well.
